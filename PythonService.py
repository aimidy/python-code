...
class PythonService(win32serviceutil.ServiceFramework):
    ...
    _svc_display_name_ = "PythonService"                 #job在windows services上顯示的名字
    _svc_description_ = "PythonService system files"        #job的描述
    ...
    def _getLogger(self):
        ...
        if os.path.isdir('%s\\log'%dirpath):  #創建log文件夾
            pass
        else:
